...
namespace TestApp.Migrations
{
    ...
    [Migration("20231127132433_InitialMigration1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalculationDeviceCheckPoint", b =>
                {
                    b.Property<int>("CalculationDevicesCalculationDeviceId")
                        .HasColumnType("integer");

                    b.Property<int>("CheckPointsCheckPointId")
                        .HasColumnType("integer");

                    b.HasKey("CalculationDevicesCalculationDeviceId", "CheckPointsCheckPointId");

                    b.HasIndex("CheckPointsCheckPointId");
            ...
            modelBuilder.Entity("CalculationDeviceCheckPoint", b =>
                {
                    b.HasOne("TestApp.Models.DbModels.CalculationDevice", null)
                        .WithMany()
                        .HasForeignKey("CalculationDevicesCalculationDeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestApp.Models.DbModels.CheckPoint", null)
                        .WithMany()
                        .HasForeignKey("CheckPointsCheckPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
