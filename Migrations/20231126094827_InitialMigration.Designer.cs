...
namespace TestApp.Migrations
{
    ...
    [Migration("20231126094827_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestApp.Models.CheckPoint", b =>
                {
            ...
            modelBuilder.Entity("TestApp.Models.ChildOrganization", b =>
                {
            ...
            modelBuilder.Entity("TestApp.Models.CurrentTransformer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CheckDate = new DateOnly(2023, 11, 26),
                            CheckPointId = 3,
            ...
            modelBuilder.Entity("TestApp.Models.ElectricityMeter", b =>
                {
            ...
            modelBuilder.Entity("TestApp.Models.ElectricitySupplyPoint", b =>
                {
            ...
            modelBuilder.Entity("TestApp.Models.ObjConsumption", b =>
                {
                    b.Property<int>("ObjConsumptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TestApp.Models.Organization", b =>
                {
                    b.Property<int>("OrganizationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TestApp.Models.VoltageTransformer", b =>
                {
            ...
            modelBuilder.Entity("TestApp.Models.CheckPoint", b =>
                {
                    b.HasOne("TestApp.Models.ObjConsumption", "ObjConsumption")
            ...
            modelBuilder.Entity("TestApp.Models.ChildOrganization", b =>
                {
                    b.HasOne("TestApp.Models.Organization", "Organization")
            ...
            modelBuilder.Entity("TestApp.Models.CurrentTransformer", b =>
                {
                    b.HasOne("TestApp.Models.CheckPoint", "CheckPoint")
                        .WithOne("CurrentTransformer")
                        .HasForeignKey("TestApp.Models.CurrentTransformer", "CheckPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TestApp.Models.ElectricityMeter", b =>
                {
                    b.HasOne("TestApp.Models.CheckPoint", "CheckPoint")
                        ...
                        .HasForeignKey("TestApp.Models.ElectricityMeter", "CheckPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TestApp.Models.ObjConsumption", b =>
                {
                    b.HasOne("TestApp.Models.ChildOrganization", "ChildOrganization")
            ...
            modelBuilder.Entity("TestApp.Models.VoltageTransformer", b =>
                {
                    b.HasOne("TestApp.Models.CheckPoint", "CheckPoint")
                        ...
                        .HasForeignKey("TestApp.Models.VoltageTransformer", "CheckPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
